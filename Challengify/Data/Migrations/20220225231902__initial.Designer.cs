...
namespace Challengify.Data.Migrations
{
    ...
    [Migration("20220225231902__initial")]
            ...
            modelBuilder.Entity("Challengify.Models.Challenge", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("16ed300e-fa8a-4d12-a401-52841850f85d"),
            ...
            modelBuilder.Entity("Challengify.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ba412e49-1aff-4db0-9164-fb9f72c5405b"),
                            Email = "mail@mail.com",
                            IsSubcriber = false,
                            Username = "nickname",
                            XP = 0
